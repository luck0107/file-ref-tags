...
import org.jetbrains.plugins.template.actions.DeleteReferenceAction
import org.jetbrains.plugins.template.actions.EditReferenceTitleAction
import org.jetbrains.plugins.template.model.ReferenceGroup
...
import org.jetbrains.plugins.template.utils.ReferenceNavigationUtils
    ...
    private fun createShowStorageButton(): JButton {
        ...
        button.addActionListener {
            ...
            if (!storageFile.exists()) {
                org.jetbrains.plugins.template.utils.NotificationUtils.showWarning(
                    project,
            ...
            org.jetbrains.plugins.template.utils.NotificationUtils.showInfo(
                project,
                MyBundle.message("action.showStorageLocation.title"),
